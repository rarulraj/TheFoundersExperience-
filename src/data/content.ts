...
export const speakers = [
  {
    ...
    role: "Co-founder & CEO",
    topic: "Building with conviction through uncertainty",
    initials: "MC",
  },
  {
    name: "Jordan Ellis",
    company: "Parcel Labs",
    role: "Founder & CTO",
    topic: "Scaling engineering culture from 10 to 80",
    initials: "JE",
  },
  {
    name: "Aisha Rahman",
    ...
    role: "Co-founder & COO",
    topic: "Operator lessons from Seed to Series B",
    initials: "AR",
  },
  {
    name: "Leo Martinez",
    company: "Signalpath",
    role: "Founder & CEO",
    topic: "Fundraising without losing your narrative",
    initials: "LM",
  },
  {
    name: "Priya Nair",
    ...
    topic: "Product decisions that compound",
    initials: "PN",
  },
  {
    name: "Sam Okonkwo",
    ...
    role: "Co-founder",
    topic: "Hiring, culture, and founder energy",
    initials: "SO",
  },
];
